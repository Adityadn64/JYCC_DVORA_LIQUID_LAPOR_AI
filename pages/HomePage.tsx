...
import {
  Skeleton,
  SkeletonChart,
} from "../components/SkeletonLoading/SkeletonLoadingHomePage";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const formattedHistory = viewData.chartLabels.map(
    ...
    <div className="space-y-20">
      <section className="text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
          Punya keluhan atau melihat masalah di sekitar Anda? Laporkan dengan
          mudah dan pantau perkembangannya secara transparan. Didukung oleh AI
          untuk penanganan yang lebih cepat dan tepat.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="text-left">
          ...
          <p className="mt-4 text-gray-600 leading-relaxed">
            Lapor.ai adalah platform terintegrasi yang merevolusi cara
            masyarakat berinteraksi dengan pemerintah. Dengan memanfaatkan
            kecerdasan buatan (AI), setiap laporan yang masuk akan dianalisis
            dan diteruskan secara otomatis ke dinas yang berwenang, memastikan
            setiap masalah ditangani oleh ahlinya tanpa penundaan.
          </p>
          <p className="mt-4 text-gray-600 leading-relaxed">
            Visi kami adalah menciptakan ekosistem pelayanan publik yang
            responsif, transparan, dan berbasis data untuk Jawa Timur yang lebih
            baik.
          </p>
        </div>
        <div>
          <div className="bg-white p-6 rounded-xl shadow-lg border">
            ...
            >
              <span className="hidden h-[333px]"></span>
              {error ? (
                renderError()
              ) : loading ? (
                <>
                  <SkeletonChart height={"[333px]"} />
                  <br />
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg border text-left">
            ...
            <p className="mt-2 text-gray-600">
              AI kami secara otomatis merutekan laporan Anda ke dinas yang
              benar, memotong birokrasi dan mempercepat waktu respons awal.
            </p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-lg border text-left">
            <h3 className="text-xl font-semibold text-gray-900">
            ...
            <p className="mt-2 text-gray-600">
              Lacak setiap progres penanganan laporan Anda secara real-time.
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border text-left">
            ...
            <p className="mt-2 text-gray-600">
              Semua laporan menjadi data berharga bagi pemerintah untuk
              menganalisis masalah dan membuat kebijakan yang lebih baik.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="text-center">
        <h2 className="text-3xl font-bold text-gray-900">
          Analisis Laporan Terkini
        </h2>
        <p className="mt-2 max-w-2xl mx-auto text-md text-gray-600">
          Statistik semua laporan yang telah masuk ke dalam sistem kami secara
          transparan.
        </p>
      ...
      <section>
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900">
            Sebaran Laporan & Kota Teraktif
          </h2>
          <p className="mt-2 max-w-2xl mx-auto text-md text-gray-600">
            Lihat sebaran laporan dan kota/kabupaten dengan jumlah laporan
