...
export default function RegisterPage({ csrfLoading }: CsrfLoadingProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const stateData = { ...formData, service_code: formData.service_code || null, kta_scan_path: response.data.kta_scan_path };
  ...
  return (
    <div className="max-w-lg mx-auto bg-white shadow-lg rounded-xl p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Halaman Registrasi</h1>
      <p className="text-gray-600 mb-8 text-center">Silakan lengkapi data di bawah ini untuk mendaftar:</p>
