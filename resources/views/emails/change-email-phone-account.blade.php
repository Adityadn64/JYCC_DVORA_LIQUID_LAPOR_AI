...
<head>
    ...
    <title>Kode Verifikasi Perubahan Email Lapor.ai</title>
    ...
    <div class="max-w-xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="text-center p-6 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-blue-600">
                Lapor<span class="text-gray-900">.ai</span> Perubahan Email
            </h1>
        </div>

        <div class="p-6 sm:p-8">
            <p class="text-gray-600 mb-6">Anda menerima email ini karena kami menerima permintaan perubahan alamat email untuk akun Anda.</p>
            <p class="text-gray-600 mb-6">{{ $isEmail ? "Token" : "Kode OTP" }} perubahan email Anda adalah:</p>
            ...
            <p class="text-gray-600 mb-6">Jika Anda tidak merasa meminta perubahan email, abaikan email ini.</p>
        </div>
