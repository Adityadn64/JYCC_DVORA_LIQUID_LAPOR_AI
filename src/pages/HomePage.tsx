...
import { homeService, reportService } from '../services/api';
...
const HomePage: React.FC<HomePageProps> = ({ appLoading }) => {
  ...
  const statusDistribution = [
    ...
    { name: 'Diproses', value: stats.process, fill: '#06B6D4' },
    { name: 'Selesai', value: stats.finished, fill: '#22C55E' },
  ...
  return (
    <div className="space-y-20">
      <section className="text-center">
        ...
        <div className="mt-10 flex justify-center items-center space-x-4 flex-wrap">
          <a
            href="/report/create"
